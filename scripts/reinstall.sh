#!/usr/bin/env bash
# Rebuild discworld-autocols.mallardx and install it to Mallard's dev plugin dir.
...
PLUGIN_NAME="discworld-autocols"
...
# Bundle plugin.toml + src; no ui/ for this plugin (Lua-only, no panel).
